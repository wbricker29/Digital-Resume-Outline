...
- [x] Build Section 3 (Artifacts) left pane with writing links (Venture Returns, State of AI, VC Tech Stack)
- [x] Add social media links (Twitter, LinkedIn, Medium) with icons
- [x] Implement media section on right pane (Koble Interview, Equidam Podcast, Associated Podcast)
- [x] Add portfolio resources links (Fundraising Guide, Portfolio Hub, Investment Learnings)
...
- ✅ Scandinavian minimalist design with teal/gray color scheme
